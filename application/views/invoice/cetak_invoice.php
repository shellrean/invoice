...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>INVOICE - <?= $invoice->kdinv ?> </title>
      ...
      <div id="details" class="clearfix">
        <table style="width: 100%">
          <tr>
            ...
            <td style="width:40%" align="right">
              <div id="invoice" >
                <h1 style="font-weight: normal"><a href="">INVOICE</a></h1>
                <iv class="date">#<?= $invoice->kdinv; ?>
                <div class="date">Date of Invoice: <?= toDateInd($invoice->invdate); ?></div>
                <div class="date">Due Date: <?= toDateInd($invoice->duedate) ?></div>
              </div>
            </td>
          </tr>
        </table>  
          ...
          <td>
            <table style="width: 100%" class="foot">
              <tr>
                ...
                <td align="right"><?= rupiah($invoice->subtotal); ?></td>
              </tr>
              <tr>
                <td colspan="2"></td>
                <td colspan="2" align="right">TAX 10%</td>
                <td align="right"><?= rupiah($invoice->tax);?></td>
              </tr>
              <tr>
                <td colspan="2"></td>
